...
export default function ResultsPage() {
  ...
  return (
    <main style={styles.container}>
      ...
      {url && <p style={styles.paragraph}>URL: <a href={url} target="_blank" rel="noopener noreferrer" style={styles.link}>{url}</a></p>}
...
<div style={styles.metricBox}>
  ...
  {/* Copy link button */}
  <button onClick={() => copyToClipboard(`https://psa-fajaede.vercel.app/results?url=${encodeURIComponent(url||'')}&score=${trustScore}`)} style={styles.copyBtn}>Kopieer link</button>
</div>
        </div>
        <div style={styles.metricBox}>
